        ...
        <>
            ...
            <section className="min-h-screen bg-primary text-white">
                ...
                <div className="container mx-auto py-16 md:py-24 px-4">
                    ...
                    {/* Subtitle */}
                    <AnimatedDiv className="flex justify-center" id="showcases-short-description" delay={0.1}>
                        <p className="mt-6 text-base md:text-lg text-white text-center max-w-3xl leading-relaxed">
